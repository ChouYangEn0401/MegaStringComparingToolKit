from isd_str_compare.legacy.EntireCompareTree.test.in_variant_matcher import tokenize, score_candidate, normalize_token
q = "chang gang univ"
...
print(res)
from isd_str_compare.legacy.EntireCompareTree.test.in_variant_matcher import normalize_token
